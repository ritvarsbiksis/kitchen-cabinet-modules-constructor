 ...
 */
export function run_wasm(target_id: string): void;
...
export interface InitOutput {
    ...
    readonly start: () => void;
    readonly __wasm_bindgen_func_elem_1683: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1691: (a: number, b: number, c: number, d: number) => void;
