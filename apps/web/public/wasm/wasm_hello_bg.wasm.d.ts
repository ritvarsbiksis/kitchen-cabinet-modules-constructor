...
export const __wasm_bindgen_func_elem_1683: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_1691: (a: number, b: number, c: number, d: number) => void;
